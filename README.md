...
| 주제 | 핵심 |
|------|------|
| [사진 업로드 API: UX 설계 판단에서 성능 최적화까지](https://velog.io/@pjm6401/냉비서-프로젝트-성능개선1) | UX vs 성능 trade-off · 19초 → 0.2초 · k6 + Grafana |
...
![QueryDSL](https://img.shields.io/badge/QueryDSL-0095D5?style=flat-square)
...
![Elastic Stack](https://img.shields.io/badge/ELK_Stack-005571?style=flat-square&logo=elastic&logoColor=white)
